    ...
    return (
        <section className="min-h-screen pb-8">
            <header className="mb-5">
                <h1 className="text-base font-semibold text-[#101828] tracking-tight">{policy.title}</h1>
                <p className="text-[#64748b] font-medium mt-1">
                    View-only policy document inside the portal.
                </p>
            </header>

            <div className="w-full h-[80vh] rounded-md overflow-hidden border border-[#E2E8F0] bg-white shadow-sm">
                <iframe
                    src={embeddedPdfSrc}
                    title={policy.title}
